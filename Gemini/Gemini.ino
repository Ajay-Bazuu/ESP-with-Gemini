...
const char* ssid = "CyborG.net";
const char* password = "Bazuu/098";
const char* Gemini_Token = "AIzaSyBIPI-iB7HwZcR7XVmY68KGxoXsIZBCZOQ";
const char* Gemini_Max_Tokens = "200";
String res = "";
